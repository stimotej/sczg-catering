...
import { najamOpremeCategoryId } from "@/lib/utils/constants";
...
export default async function NajamOpremePage() {
  const posts = await getPostsByCategoryId(najamOpremeCategoryId);
